...
```
Click the url in the output info generated by flask (defaults to `http://0.0.0.0:5000/` and `http://127.0.0.1:5000/`), then `onnx-modifier` will be launched in the web browser.
